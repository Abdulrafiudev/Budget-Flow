      ...
      <DialogContent className="max-w-lg">
        <div className="text-center space-y-6 py-4">
          ...
          <div className="space-y-3">
            ...
            <h2 className="text-3xl font-bold text-balance">Congratulations!</h2>
            <p className="text-lg text-muted-foreground">
              You've added <span className="font-bold text-foreground">{formatCurrency(amount, currency)}</span> to your
              budget
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="text-left space-y-2">
              <h3 className="font-semibold text-base">Time to Distribute Your Income</h3>
              <p className="text-sm text-muted-foreground text-pretty">
                Transfer these amounts to their respective accounts to stay on track with your budget plan:
              </p>
            </div>
            ...
            <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <p className="text-xs text-muted-foreground">{distribution.spend_percentage}%</p>
                    </div>
              ...
              <Card className="p-4 bg-green-50 dark:bg-green-950/20 border-green-200 dark:border-green-900">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      <p className="font-semibold text-sm">Investment Account</p>
                      <p className="text-xs text-muted-foreground">{distribution.investment_percentage}%</p>
                    </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      <p className="text-xs text-muted-foreground">{distribution.savings_percentage}%</p>
                    </div>
          ...
          {/* Action Buttons */}
          <div className="space-y-3">
            <p className="text-sm text-muted-foreground">We'll remind you tomorrow to complete your distribution!</p>
